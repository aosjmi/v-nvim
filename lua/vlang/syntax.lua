...
function M.setup()
  ...
  local function syntax_cmd(str)
    vim.cmd('syntax ' .. str)
  end

  syntax_cmd('cluster vStringGroup contains=@vCharacterGroup,vStringError')
  syntax_cmd([[region vString start=+"+ skip=+\\\\\|\\"+ end=+"+ contains=@vStringGroup]])
  syntax_cmd([[region vString start=+'+ skip=+\\\\\|\\'+ end=+'+ contains=@vStringGroup]])
  syntax_cmd('region vRawString start=+r"+ end="+"')
  syntax_cmd('region vRawString start=+r\'+ end=+\'+')

  vim.cmd('highlight default link vString String')
  vim.cmd('highlight default link vRawString String')
